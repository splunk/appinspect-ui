...
Menu.Item = dynamic(
  () => import("@splunk/react-ui/Menu").then((mod) => mod.Item),
  {
    ssr: false,
  }
);
Menu.Divider = dynamic(
  () => import("@splunk/react-ui/Menu").then((mod) => mod.Divider),
  {
    ssr: false,
  }
);
...
List.Item = dynamic(
  () => import("@splunk/react-ui/List").then((mod) => mod.Item),
  {
    ssr: false,
  }
);
...
async function checkstatus(
  ...
  if (typeof token !== undefined) {
    while (true) {
      ...
      var status = await ipcRenderer
        .invoke("getreportstatus", {
          token: token,
      ...
      if (finalReport.summary.error > 0) {
        <>
          ...
          >
            ...
            >
              Oops! Something went wrong. It looks like we&#39;re having an
              issue with the appinspect service.
            </Heading>
          </SplunkThemeProvider>
        </>;
          ...
          <>
            ...
            >
              ...
              >
                ...
                Splunkbase or as a private app - check out the Failures tab
                below to see what&#39;s left for you to do.
              </Heading>
            </SplunkThemeProvider>
          </>
        );
          ...
          <>
            ...
            >
              <Heading
                ...
                style={{ width: "50%", alignText: "center", margin: "auto" }}
              >
                Woah, great job on the app! All that&#39;s left are some items
                that need to be manually checked. Check out the Manual
                Check&#39;s tab below to see what will get reviewed.
              </Heading>
            </SplunkThemeProvider>
          </>
        );
            ...
            <tr>
              <td>
                ...
                >
                  ...
                  <Modal.Body>
                    <P>
                      Provide an AppInspect request ID to lookup a previously
                      run report.
                    </P>
                    <P>
